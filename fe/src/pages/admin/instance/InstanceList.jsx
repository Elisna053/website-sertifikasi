...
import { FiPlus, FiEdit2, FiTrash2, FiSearch, FiList, FiCalendar } from "react-icons/fi";
...
const InstanceList = () => {
  ...
  const handleInputChange = (e) => {
   ...
   const handleViewJadwal = (instanceId) => {
    navigate(`/admin/instance/${instanceId}/jadwal`);
  };
              ...
              {filteredInstances.map((instance, index) => (
                <TableRow key={instance.id}>
                  ...
                  <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleViewJadwal(instance.id)}
                      className="flex items-center gap-1"
                    >
                      <FiCalendar className="h-4 w-4" /> Jadwal
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
